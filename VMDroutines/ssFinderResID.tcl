...
if { [llength $argv] != 3 || [lindex $argv 0] == "-h" } {
    puts "Usage: vmd -e script.tcl -args <proteinFile> <topology> <trajectoryFile> <outputFile>"
...
set proteinResNum [uniqueList [$proteinSel get "resid"]]
